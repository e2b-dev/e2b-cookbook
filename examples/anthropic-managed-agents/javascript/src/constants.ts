...
export const REMOTE_APP_WEBHOOK = `${REMOTE_SRC_DIR}/app-webhook-server.ts`;
...
export const REMOTE_ANTHROPIC_API_KEY = `${REMOTE_CONFIG_DIR}/anthropic-api-key`;
export const REMOTE_E2B_API_KEY = `${REMOTE_CONFIG_DIR}/e2b-api-key`;
export const REMOTE_APP_WEBHOOK_ADMIN_TOKEN = `${REMOTE_CONFIG_DIR}/app-webhook-admin-token`;
export const REMOTE_APP_SANDBOX_ROUTING_SCOPE = `${REMOTE_CONFIG_DIR}/app-sandbox-routing-scope`;
