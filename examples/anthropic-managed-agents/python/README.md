...
Run Anthropic Managed Agents self-hosted environment workers from E2B sandboxes.
...
| `ANTHROPIC_ENVIRONMENT_KEY` | Generate this in the Anthropic Console environment page. |
