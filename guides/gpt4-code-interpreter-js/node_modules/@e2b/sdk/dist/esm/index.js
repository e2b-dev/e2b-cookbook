...
client.configure({
    ...
    init: {
        headers: {
            ...
            system: ((_a = platform.os) === null || _a === void 0 ? void 0 : _a.family) || 'unknown',
            publisher: 'e2b',
        },
    },
});
...
export { FilesystemOperation, FilesystemWatcher, Process, ProcessMessage, ProcessOutput, Session, Terminal, TerminalOutput, client as api, runCode };
